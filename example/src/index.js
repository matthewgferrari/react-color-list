...
function NotificationWrapper(props) {
  ...
  return (
    ...
    iconVariant={
      ...
      { error: <span style = {{marginRight:".5rem"}}><AlertIcon /></span> }}
      ref={notistackRef}
...
function AlertIcon (){
  return (
    <svg width="1.5rem" height="1.5rem" viewBox="0 0 16 16" className="bi bi-exclamation-triangle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
