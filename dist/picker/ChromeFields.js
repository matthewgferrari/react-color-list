...
export class ChromeFields extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "toggleViews", () => {
    ...
    _defineProperty(this, "handleChange", (data, e) => {
      if (data.hex) {
    ...
    _defineProperty(this, "showHighlight", e => {
      e.currentTarget.style.background = '#eee';
    });

    _defineProperty(this, "hideHighlight", e => {
...
function UnfoldMoreHorizontalIcon(props) {
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("svg", _extends({
    ...
    d: "M12 18.17L8.83 15l-1.41 1.41L12 21l4.59-4.59L15.17 15M12 5.83L15.17 9l1.41-1.41L12 3 7.41 7.59 8.83 9 12 5.83z",
    fill: "#626262"
  })));
}
